        ...
        },
        {
            ...
            render: () => (
                <button
                    ...
                    className="text-brand-500 hover:text-brand-600 font-medium text-xs border border-brand-500/30 px-3 py-1 rounded hover:bg-brand-50 transition-colors"
                >
                    Track
                </button>
            )
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    ...
                    <p className="text-[#555555]">Loading master database...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full px-6 py-8">
            <motion.div
                ...
                className="mb-8"
            >
                <h1 className="text-3xl font-bold text-[#222222] mb-2 font-display">All Shipments</h1>
                <p className="text-[#555555]">Master view of all shipments across the network.</p>
            </motion.div>
